...
export default function Terms() {
  return (
    <div className="min-h-screen h-full pt-44 md:pt-32">
      <div className="flex justify-center flex-row">
        <div className="lg:w-[768px] w-fit p-6 space-y-6 dark:text-white">
          <section>
            <h1 className="md:text-6xl text-xl font-bold">Privacy Policy</h1>
          ...
          <ul className="list-disc pl-6 mt-2">
            ...
            <li>
              <strong>Club</strong> (referred to as either "the Club", "We",
              "Us" or "Our" in this Agreement) refers to SIIT Academy Club -
              OrcaBOT.
            </li>
            <li>
            ...
            <li>
              ...
              person who processes the data on behalf of the Club. It refers to
              third-party companies or individuals employed by the Club to
              facilitate the Service, to provide the Service on behalf of the
              Club, to perform services related to the Service or to assist the
              Club in analyzing how the Service is used.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to SIIT Academy Club - OrcaBOT,
              accessible from{" "}
              <Link
                href="https://orcabot.in.th"
                className="underline"
                target="_blank"
          ...
          <h3 className="text-xl font-semibold">Types of Data Collected</h3>
          <p className="mt-4">
            The Club allows You to create an account and log in to use the
          ...
          <p className="mt-4">
            ...
            the option of sharing additional information with the Club through
            ...
            otherwise, You are giving the Club permission to use, share, and
          ...
          <ul className="list-disc pl-6 mt-2">
            <li>
              <strong>Cookies or Browser Cookies.</strong> Our website requires
              the use of cookies to function properly. By using our service, you
              agree to the placement of these cookies on your device. You can
              refuse cookies if you choose, but please be aware that this may
              limit your ability to use certain features of our service. Unless
              you have adjusted your browser settings to refuse cookies, our
              service may use them to ensure its proper operation.
            </li>
            <li>
              <strong>Web Beacons.</strong> Certain sections of our Service and
              our emails may contain small electronic files known as web beacons
              (also referred to as clear gifs, pixel tags, and single-pixel
              gifs) that permit the Club, for example, to count users who have
          ...
          <ul className="list-disc pl-6 mt-2">
            ...
            <p className="mt-4">Type: Session Cookies</p>
            <p className="mt-4">
            ...
            <p className="mt-4">Type: Persistent Cookies</p>
            <p className="mt-4">
          ...
          <ul className="list-disc pl-6 mt-2">
            ...
            <li>
              ...
              telephone calls, SMS, LINE, or other equivalent forms of
            ...
            <li>
              <strong>For business transfers:</strong> means any natural or
              legal person who processes the data on behalf of the Club. It
              refers to third-party companies or individuals employed by the
              Club to facilitate the Service, to provide the Service on behalf
              of the Club, to perform services related to the Service or to
              assist the Club in analyzing how the Service is used.
            </li>
            <li>
              <strong>For other purposes:</strong> refers to any website or any
            ...
            <li>
              ...
              negotiations of, any merger, sale of Club assets, financing, or
          ...
          <p className="mt-4">
            The Club will retain Your Personal Data only for as long as is
            necessary for the purposes set out in this Privacy Policy. We will
            retain and use Your Personal Data to the extent necessary to comply
            with our legal obligations (for example, if we are required to
            retain your data to comply with applicable laws), resolve disputes,
            and enforce our legal agreements and policies. The Club will also
          ...
          <p className="mt-4">
            ...
            Club's operating offices and in any other places where the parties
            ...
            Your agreement to that transfer. The Club will take all steps
          ...
          <p className="mt-4">
            You have the right to delete your account and request assistance in
            deleting the Personal Data we have collected about you. To delete
            your account, please contact us directly. While we will process your
            request, please note that we may need to retain certain information
            if we have a legal obligation or lawful basis to do so.
          </p>
          <div className=" border-b" />
          ...
          <p className="mt-4">
            If the Club is involved in a merger, acquisition or asset sale, Your
          ...
          <p className="mt-4">
            Under certain circumstances, the Club may be required to disclose
            Your Personal Data if required to do so by law or in response to
            valid requests by public authorities (e.g. a court or a government
            agency) or by Sirindhorn International Institute of Technology,
            Thammasat University.
          </p>
          <h3 className="text-xl font-semibold">Other legal requirements</h3>
          <p className="mt-4">
            The Club may disclose Your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <ul className="list-disc pl-6 mt-2">
            <li>Comply with a legal obligation</li>
            <li>Protect and defend the rights or property of the Club</li>
            <li>
          ...
          <ul className="list-disc pl-6 mt-2">
            <li>
              By email:{" "}
              <a href="mailto:support@orcabot.in.th" className="underline">
                support@orcabot.in.th
              </a>
            </li>
          </ul>
        </div>
